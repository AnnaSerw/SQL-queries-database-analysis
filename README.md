...
To summarize: we can see the total number of tracks in the data base as 3503. 
The number of tracks that are sold is 1984. But there are some of them (as we consider the all database) which have no interest. 
The number of titles that are not sold is 1519. We have already indicated all of them as you can see in query 3.
